...
const program = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Oblique Cable Crunch", url: `${SITE}oblique-cable-crunch`, sets: "3", reps: "10", note: "⚡ Антиротація — ключова для стабілізації хребта при сколіозі", weight: [8, 12, 18, "кг"] },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Oblique Cable Crunch", url: `${SITE}oblique-cable-crunch`, sets: "3", reps: "10", note: "⚡ Антиротація — стабілізація хребта при сколіозі", weight: [8, 12, 18, "кг"] },
      { name: "Cable Crunch", url: `${SITE}cable-crunch.html`, sets: "4", reps: "10", note: null, weight: [20, 30, 45, "кг"] },
      { name: "Hip Abduction Machine", url: `${SITE}hip-abduction-machine.html`, sets: "3", reps: "12", note: "⚡ Gluteus medius — ключовий м'яз для корекції APT", weight: [20, 30, 45, "кг"] },
    ],
    cooldown: [
